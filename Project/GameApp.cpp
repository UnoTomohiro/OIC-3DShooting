...
MofBool CGameApp::Initialize(void){
	...
	//カメラ初期化
	gCamera.SetViewPort();
	gCamera.LookAt(Vector3(0, 6, -17.0f), Vector3(0, 0, -10),Vector3(0, 1, 0));
...
MofBool CGameApp::Render(void){
	...
	if (gbDebug)
	{
		...
		//移動可能範囲の表示
		CMatrix44 matWorid;
		matWorid.Scaling(FIELD_HALF_X * 2, 1, FIELD_HALF_Z * 2);
		CGraphicsUtilities::RenderPlane(matWorid, Vector4(1, 1, 1, 0.4f));
	}
